  ...
  return (
    <div style={fullPageStyle}>
      ...
      <div style={contentBoxStyle}>
        {/* Grid Watermark Removed for a cleaner look */}
        ...
        <div style={mainProfileLayout}>
          ...
          <div style={photoContainer}>
            <img 
              src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=380&h=500&fit=crop"
              alt="Doyoung An" 
              style={photoStyle} 
            />
          ...
          <div style={textContentStyle}>
            ...
            <nav style={navLinksStyle}>
              {['About Me', 'CV', 'Projects', 'Contact'].map((label) => {
                // Routing Fix: Matches App.jsx "/about_me"
...
const verticalLineLeft = { 
  ...
  bottom: 0, 
  width: '1px', 
  background: 'rgba(196, 192, 183, 0.4)',
  zIndex: 1
};
...
const photoTick = {
  ...
  width: '24px',
  height: '24px',
  borderLeft: '1px solid #C4C0B7',
  borderTop: '1px solid #C4C0B7'
};
